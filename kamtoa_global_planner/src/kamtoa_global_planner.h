...
#ifndef _KAMTOA_GLOBAL_PLANNER_H
#define _KAMTOA_GLOBAL_PLANNER_H
...
class KamtoaGlobalPlanner : public nav_core::BaseGlobalPlanner {
public:
  
  KamtoaGlobalPlanner(ros::NodeHandle &); //this constructor is may be not needed
  KamtoaGlobalPlanner();
  KamtoaGlobalPlanner(std::string name, costmap_2d::Costmap2DROS* costmap_ros);
...
#endif // _KAMTOA_GLOBAL_PLANNER_H